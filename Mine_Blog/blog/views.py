...
def post_list(request, tag_slug=None):
   ...
   paginator = Paginator(posts, 3) # 10 posts in each page
...
def post_detail(request, post):
    ...
    return render(request, 'post_detail.html',{'post':post,'comments': comments,'comment_form':CommentForm,'similar_posts':similar_posts})
